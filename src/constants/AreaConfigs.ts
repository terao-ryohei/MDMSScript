 ...
 */
export function getLandmarksInRange(location: Vector3, maxDistance: number): Landmark[] {
 ...
 * 距離計算のヘルパー関数
 */
function calculateDistance(pos1: Vector3 | {x: number, y: number, z: number}, pos2: {x: number, y: number, z: number}): number {
