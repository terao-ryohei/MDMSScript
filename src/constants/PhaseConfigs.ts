...
export const PHASE_CONFIGS: Record<GamePhase, PhaseConfig> = {
  ...
  [GamePhase.DAILY_LIFE]: {
    ...
    duration: 1200, // 20分
    allowedActions: ["move", "chat", "use_item", "break_block", "place_block", "interact", "task", "murder"],
  ...
  [GamePhase.INVESTIGATION]: {
    ...
    description: "証拠収集と分析",
    duration: 720,  // 12分
    allowedActions: ["move", "chat", "collect_evidence", "use_ability", "analyze"],
  ...
  [GamePhase.REINVESTIGATION]: {
    ...
    description: "追加調査と密談",
    duration: 540,  // 9分
    allowedActions: ["move", "chat", "collect_evidence", "secret_talk", "trade"],
