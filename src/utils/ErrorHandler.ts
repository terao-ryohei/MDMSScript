...
export const logError = (
  ...
  console.error(`[${timestamp}] ${severity.toUpperCase()}: ${message}${contextStr}`);
...
export class PlayerActionError extends Error {
  constructor(message: string, public playerId: string, public action: string) {
    super(message);
