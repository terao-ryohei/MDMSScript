 ...
 * 投票記録
 */
export interface VoteRecord extends Record<string, unknown> {
 ...
 * 投票セッション
 */
export interface VotingSession extends Record<string, unknown> {
	id: string; // セッションID
	voteType: VoteType; // 投票タイプ
 ...
 * 投票結果
 */
export interface VotingResult extends Record<string, unknown> {
